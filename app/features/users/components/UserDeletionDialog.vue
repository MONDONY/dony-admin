...
<template>
  <!--
    Constat 2 — la <Transition name="backdrop"> reste toujours montée.
    Le v-if est porté par l'élément À L'INTÉRIEUR, pas par un parent qui
    l'engloberait : quand open passe à false, Vue peut jouer leave-active
    avant de retirer le nœud du DOM.
  -->
  <Transition name="backdrop">
    ...
    >
      <!--
        Constat 4 — role="dialog" + aria-modal + aria-labelledby pour les
        lecteurs d'écran. L'id "dialog-title" pointe vers le <h2>.
        Constat 2 — la Transition interne n'a plus de v-if redondant :
        la carte est toujours présente dès que le backdrop est rendu.
      -->
      <Transition name="dialog" appear>
        ...
        >
          ...
          <header class="border-b border-border px-6 py-4">
            ...
            -->
            <h2 id="dialog-title" class="font-display text-lg font-semibold [text-wrap:balance]">
          ...
          <div class="flex-1 overflow-y-auto px-6 py-4">
            ...
            >
              ...
              <div>
                ...
                <select
                  ...
                  class="w-full rounded-btn border border-border bg-bg p-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary/40"
                >
            ...
            <p
              ...
              class="mt-3 rounded-xs border border-danger/40 bg-danger/10 px-3 py-2 text-sm text-danger [text-wrap:pretty]"
            >{{ error }}</p>
          </div>
          ...
          <footer class="flex justify-end gap-2 border-t border-border px-6 py-4">
            ...
            <button
              ...
              class="
                min-h-[40px] rounded-btn border border-border px-4 py-2 text-sm
            ...
            <button
              ...
              :disabled="!canConfirm"
              class="
                min-h-[40px] rounded-btn bg-danger px-4 py-2 text-sm text-white
